package com.test.querydsl.repository.support;
...
public abstract class Querydsl4RepositorySupport<T> {
    ...
    public void setEntityManager(EntityManager entityManager) {
        ...
        Class<T> domainClass = getGenericClass(getClass());
    ...
    public static <T> Class<T> getGenericClass(Class<?> clazz) {
        ...
        if (!(type instanceof ParameterizedType)) {
            throw new IllegalArgumentException("It is not a class that inherits only one generic class.");
        }
